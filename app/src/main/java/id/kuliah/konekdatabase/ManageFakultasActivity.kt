...
class ManageFakultasActivity : AppCompatActivity() {
    ...
    private fun onEditMode(){
        txt_kodeFak.setText(i.getStringExtra("txt_kodeFak"))
        txt_namaFak.setText(i.getStringExtra("txt_namaFak"))
    ...
    private fun onCreate(){
        ...
        AndroidNetworking.post(ApiEndPoint.CREATE)
            .addBodyParameter("kodeFak", txt_kodeFak.text.toString())
            .addBodyParameter("namaFak", txt_namaFak.text.toString())
